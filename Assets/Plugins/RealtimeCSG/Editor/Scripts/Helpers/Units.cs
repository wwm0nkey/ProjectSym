...
namespace RealtimeCSG
{
	...
	public static class Units
	{
		...
		const decimal meter_to_centimeter	= 100.0m;
		const decimal meter_to_millimeter	= 1000.0m;
		const decimal meter_to_inches		= 39.37007874m;
		const decimal meter_to_feet			= 3.28084m;
		const decimal emperial_rounding		= 10000000m;
